...
//    xLastWakeTime = xTaskGetTickCount();
    ...
    for ( ;; )
    {
        ...
        int32_t height = readCircBuf(&g_inBuffer);
        int32_t altitude = computeAltitude();
        int32_t percent = percentAltitude();
...
//        vPrintString("ADC INT Worked");
//        printf("ADC INT Worked");
//        vPrintString(computeAltitude(), percentAltitude());
...
//        UARTSend (statusStr);
        ...
        usprintf (statusStr, "Percent: %d\r\n", percent);
        UARTSend (statusStr);
//        usprintf (statusStr, "\nAltitude: %d\r", percent);
//        UARTSend (statusStr);
